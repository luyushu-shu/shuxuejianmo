...
md(
    r"""## 6. 问题 4：FY1/FY2/FY3 各投 1 枚干扰 M1
...
code(
    r'''def optimize_multi_on_uav(uav_name, missile_name, n_bombs):
    uav0, p_m = UAVS[uav_name], MISSILES[missile_name]
...
md("## 8. 导出 result1/2/3.xlsx 与汇总图表")

code(
    r'''def ang_deg(heading):
...
path = Path(__file__).resolve().parent / "A题_烟幕干扰弹投放策略.ipynb"
